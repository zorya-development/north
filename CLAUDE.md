...
└── crates/
    ...
    │       │   └── traversable_task_list/ # Container/controller/view (keyboard-driven tree list with inline edit/create)
    │       └── components/
